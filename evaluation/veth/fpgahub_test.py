...
def run_once(run_dir):
    ...
    subprocess.run(["fpgahub", "push"], cwd="./veth_v1/")
    ...
    results.append(
        run_and_monitor(
            ["fpgahub", "pull", "eth_mac_phy_10g_fifo"],
            "pull",
            "./temp_dir/",
            proc_log,
        )
    ...
    shutil.copytree("./temp_dir/.fpgahub", "./veth_v2/.fpgahub")

    results.append(
        run_and_monitor(
            ["fpgahub", "commit", "eth_mac_phy_10g_fifo"],
            "commit",
            "./veth_v2/",
            proc_log,
        )
    )
    results.append(run_and_monitor(["fpgahub", "push"], "push", "./veth_v2/", proc_log))
